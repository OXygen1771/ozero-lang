...
static_assert(sizeof(u64) == 8, "u64 must be exactly 8 bytes"); // NOLINT
...
static_assert(sizeof(i64) == 8, "i64 must be exactly 8 bytes"); // NOLINT

static_assert(sizeof(f32) == 4, "f32 must be exactly 4 bytes");
static_assert(sizeof(f64) == 8, "f64 must be exactly 8 bytes"); // NOLINT
